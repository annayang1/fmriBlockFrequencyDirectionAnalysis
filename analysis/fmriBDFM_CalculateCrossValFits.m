function [fitResultsStructAvgResponseCellArray] = fmriBDFM_CalculateCrossValFits(packetCellArray, hrfKernelStructCellArray)
...
for ss=1:nSubjects
    for ii=1:length(modDirections)
        ...
        subPacketCellArray=packetCellArray(theCellIndices);
